...
class CrearBolson : AppCompatActivity() {
        ...
        lifecycleScope.launch {
            ...
            if (result_ronda != null) {
                ...
                for (each in listaQuintas.subList(1, listaQuintas.size - 1)) {
                    visitaAjena =
                        VisitaFechaList.getVisitaById(each.id_quinta!!, result_visitas.visitas!!)
                    ...
                    override fun onItemSelected(
                        ...
                        binding.submit.setOnClickListener {
                            ...
                            if (result_bolson!!.any { it.idFp == id_fp }) {
                                ...
                                val dCreate= DialogHelper.espera(this@CrearBolson)
                                dCreate.show()
    ...
    fun initView(
        listaVerduraPropia: List<ParcelaVerdura>,
        listaVerduraAjena: List<ParcelaVerdura>
    ) {
