...
class QuintaAdapter(val listaQuinta: List<Quinta>, val listaFamilia: List<FamiliaProductora>, private val editOnClickListener:(Quinta) -> Unit,val routeOnClickListener:(Quinta) -> Unit, private val deleteOnClickListener:(Quinta) -> Unit): RecyclerView.Adapter<QuintaViewHolder>() {
    ...
    override fun onBindViewHolder(holder: QuintaViewHolder, position: Int) {
        ...
        holder.render(item!!,itemF!!, editOnClickListener,routeOnClickListener,deleteOnClickListener)
    }
